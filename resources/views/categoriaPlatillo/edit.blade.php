<html>
 ...
 function soloLetras(e){
        ...
        <body>
            ...
            <input type="text" name="nombre_categoria" required onkeypress="return soloLetras(event)" onpaste="return false;" maxlength="10" value="{{old('nombre_categoria',$categoriaPlatillo->nombre_categoria)}}"><br>
